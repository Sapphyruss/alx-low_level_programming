 ...
 * Return: pointer to hash table created, or NULL if malloc failed.
 */
...
/**
 * set_spair - mallocs a key/value to the sorted hash table.
 ...
 * @value: the value associated with the key can be empty.
 * @index: the key index.
 * Return: the new node, NULL if failed.
 */
 ...
 * @key: the key - cannot be empty.
 * Return: the value associated with the key, NULL if key not found.
 */
